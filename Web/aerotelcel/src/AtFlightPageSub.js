/*
 *  Title: Subscription Flight Page for Aerotelcel
 *  Author: Marcos Gonzalez Fernandez
 *  Date: 23/03/2024
 *  Description: This is the subscription flight page for the Aerotelcel web app
 *  Code Version: 1.0
...
const ATFlightPage = () => {
    ...
    const postDataDynamic = (name, email, flightID) => {
    ...
    const handleButtonClick = () => {
        ...
        postDataDynamic(input1, input2, flightID);
